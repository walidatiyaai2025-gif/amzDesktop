...
Console.Title = "Remote Screen Desktop V2.2";

using var server = new RemoteServer();
server.Start();

Console.WriteLine("==================================================");
Console.WriteLine(" Remote Screen Desktop V2.2");
Console.WriteLine("==================================================");
...
if (!string.IsNullOrWhiteSpace(server.AudioError))
    Console.WriteLine($" Audio info : {server.AudioError}");
Console.WriteLine();
